...
public class DataPreviewLineChartActivity extends AppCompatActivity {
    ...
    private ArrayList<SensorData> listToPlot;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_data_preview_line_chart);

        listToPlot = getIntent().getParcelableArrayListExtra("ListOfData");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_data_preview_line_chart, menu);
        return true;
    }
    ...
    private void generateDefaultData(ArrayList<SensorData> listToPlot) {
        int numValues = listToPlot.size();

        List<PointValue> values = new ArrayList<PointValue>();
        for (int i = 0; i < numValues; ++i) {
            SensorData value1 = listToPlot.get(i);
            values.add(new PointValue(i, Float.parseFloat("" + value1.getX())));
        }
