...
public class MapDetailsTab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_details_tab);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_map_details_tab, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private static final String ARG_PAGE_TITLE = "section_title";
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_map_details_tab, container, false);
            int position = getArguments().getInt(ARG_SECTION_NUMBER);
            CharSequence pageTitle = getArguments().getCharSequence(ARG_PAGE_TITLE);
            ...
            for (int x = 0; x < integers.size(); ++x) {
                float yValue = integers.get(x);
                values.add(new PointValue(x, yValue));
                AxisValue axisValueX = new AxisValue(x);
                axisValueX.setLabel(labels.get(x));
                axisValuesX.add(axisValueX);

                AxisValue axisValueY = new AxisValue(x);
                axisValueY.setLabel(String.valueOf(integers.get(x)));
